...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // Brand keywords
    "better components",
    "better components background",
    "bettercomponents",
    "bettercomponents background",
  ...
  authors: [{ name: "bikash Bari", url: "https://github.com/bikash1376" }],
  creator: "bikash",
  publisher: "better components",
  ...
  openGraph: {
    ...
    url: "https://bettercomponents.vercel.app",
    siteName: "better components",
    type: "website",
    images: [
      {
        url: "/og-banner.png",
        width: 1200,
        height: 630,
        alt: "better components – Modern Background Patterns and Gradients Snippets",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://bettercomponents.vercel.app",
  },
  ...
  applicationName: "Better Components",

  // Schema.org structured data hints
  other: {
    "application-name": "Better Components",
    "mobile-web-app-capable": "yes",
    "apple-mobile-web-app-capable": "yes",
    "apple-mobile-web-app-status-bar-style": "default",
    "apple-mobile-web-app-title": "Better Components",
    ...
    // Rich snippets hints
    "article:author": "bikash Bari",
    "article:publisher": "https://github.com/bikash-bari",
    ...
    "distribution": "global",
    "rating": "general",
    "copyright": "© 2025 bikash Bari. All rights reserved.",
  },
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        {/* og image */}
        <meta property="og:image" content="https://bettercomponents.vercel.app/og-banner.png" />
        <meta name="twitter:image" content="https://bettercomponents.vercel.app/og-banner.png" />

        {/* <meta property="og:image" content="https://bettercomponents.vercel.app/opengraph-image.png" />
        <meta property="og:image:type" content="image/png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />

        <meta name="twitter:image" content="https://bettercomponents.vercel.app/twitter-image.png" />
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "author": {
                "@type": "Person",
                "name": "bikash Bari",
                "url": "https://github.com/bikash-bari"
              },
              "publisher": {
                "@type": "Organization",
                "name": "Better Components",
              ...
              "screenshot": [
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-1.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-2.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-3.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-4.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-5.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-6.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-7.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-8.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-9.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-10.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-11.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-12.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
                  "contentUrl": "https://bettercomponents.vercel.app/snapshots/screenshot-13.png",
                  "description": "better components - Modern Background Patterns & Gradients Snippets"
                },
                {
                  "@type": "ImageObject",
              ...
              "sameAs": [
                "https://github.com/bikash1376",
                "https://x.com/bikashtrix",
                "https://bettercomponents.vercel.app"
              ],
              "featureList": [
